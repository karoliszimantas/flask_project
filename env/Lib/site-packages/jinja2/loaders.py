...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'base_html.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/base_html.html'`` the file from the app1 package is loaded,
    by loading ``'app2/base_html.html'`` the file from the second.
    """
